...
export const EXERCISES: ExerciseDef[] = [
  ...
  { id: 'chop-wood', name: 'Chopping / Splitting Wood', pattern: 'activity', kind: 'activity', equipment: ['bodyweight'], unit: 'minutes', defaultQuantity: 45, met: 6.3 },
  { id: 'shoveling', name: 'Shoveling / Digging', pattern: 'activity', kind: 'activity', equipment: ['bodyweight'], unit: 'minutes', defaultQuantity: 30, met: 6 },
  { id: 'manual-labor', name: 'Manual Labor / Hauling', pattern: 'activity', kind: 'activity', equipment: ['bodyweight'], unit: 'minutes', defaultQuantity: 60, met: 5.5 },
